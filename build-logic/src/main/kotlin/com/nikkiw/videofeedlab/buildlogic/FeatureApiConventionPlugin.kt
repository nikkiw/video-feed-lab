...
/**
 * A simple convention plugin for feature API modules.
 */
class FeatureApiConventionPlugin : Plugin<Project> {
    override fun apply(target: Project) = with(target) {
        ...
        pluginManager.apply("com.nikkiw.videofeedlab.detekt-convention")
        pluginManager.apply("com.nikkiw.videofeedlab.spotless-convention")
        ...
        configure<KotlinMultiplatformExtension> {
            targets.getByName("android").apply {
                ...
                val pathNamespace = project.path
                    ...
                    .replace("-", "_")
                    .removePrefix(".")
                androidTarget.namespace = "com.nikkiw.videofeedlab.$pathNamespace"
